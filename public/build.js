...
electron.app.setPath('userData', path.join(electron.app.getPath('home'), '.yourdlt-wallet'))
    ...
    submenu: [
      {
        label: 'Learn More',
        click: function () {
          electron.shell.openExternal('https://github.com/UsingBlockchain/yourdlt-wallet')
        },
      },
      {
        label: 'About YourDLT',
      ...
      {
        label: 'About Using Blockchain Ltd',
        click: function () {
          electron.shell.openExternal('https://using-blockchain.org')
        },
      },
    ],
  },
